...
$admin_reservation_link = admin_url('post.php?post=' . $rezerwacja_id . '&action=edit');
                        ...
                        <tbody>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="font-size: 18px;font-weight: bold;color: #000;padding-bottom: 12px;border-bottom: 1px solid #eeeeee">
                                                    Nowa rezerwacja w systemie FlexMile!
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td align="right" style="padding:12px 0;font-size:15px;color:#333;border-bottom: 1px solid #eeeeee;font-weight: bold">
                                                    <?php echo esc_html($reservation_number); ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding:12px 0;font-size:15px;color:#333;border-bottom: 1px solid #eeeeee">
                            ...
                            <tr>
                                <td style="padding:20px 24px;text-align:center">
                                    <a href="<?php echo esc_url($admin_reservation_link); ?>" style="display:inline-block;background-color:#863087;color:#ffffff;padding:12px 30px;text-decoration:none;border-radius:4px;font-weight:bold;font-size:14px">
